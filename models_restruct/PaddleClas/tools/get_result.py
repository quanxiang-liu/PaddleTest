...
def run():
    ...
    update_name = {
        "PaddleClas-Linux-Cuda102-Python37-P0-Develop": "22381042/result.tar",
        "PaddleClas-Linux-Cuda102-Python37-P1-Develop": "22381038/result.tar",
        "PaddleClas-Linux-Cuda102-Python37-P11-Develop": "22379908/result.tar",
        "PaddleClas-Linux-Cuda102-Python37-P12-Develop": "22379907/result.tar",
        "PaddleClas-Linux-Cuda112-Python38-P0-Develop": "22381147/result.tar",
        "PaddleClas-Linux-Cuda116-Python39-P0-Develop": "22381144/result.tar",
        "PaddleClas-Linux-Cuda117-Python310-P0-Develop": "22381118/result.tar",
        "PaddleClas-Linux-Cuda116-Python39-P0-Develop-Centos": "22381122/result.tar",
    }
